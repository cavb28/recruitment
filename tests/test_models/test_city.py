...
class TestCityDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_city(self):
        """Test that models/victim.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(['models/victim.py'])
    ...
    def test_city_module_docstring(self):
        """Test for the victim.py module docstring"""
        self.assertIsNot(victim.__doc__, None,
                         "victim.py needs a docstring")
        self.assertTrue(len(victim.__doc__) >= 1,
                        "victim.py needs a docstring")
